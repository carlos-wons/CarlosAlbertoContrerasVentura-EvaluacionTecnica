...
public class SalidaDialog extends JDialog {
     ...
     * @param maxCantidad stock actual del producto (se usará como máximo en el spinner)
     */
    public SalidaDialog(Frame owner, String nombreProducto, int maxCantidad) {
        super(owner, "Salida: " + nombreProducto, true);
        this.maxCantidad = Math.max(1, maxCantidad);
        init();
        setSize(400, 300);
    ...
    private void init() {
        cantidadSpinner = new JSpinner(new SpinnerNumberModel(1, 1, maxCantidad, 1));
        JSpinner.DefaultEditor editor = (JSpinner.DefaultEditor) cantidadSpinner.getEditor();
        ...
        JButton btnOk = new JButton("Sacar");
        ...
        gbc.gridx=0; gbc.gridy=0; p.add(new JLabel("Cantidad (máx " + maxCantidad + "):"), gbc);
